...
from api.caja.serializers import AbrirCajaView, CajaView, CerrarCajaView, CajaAbiertaView, ExistCajaAbiertaView
...
urlpatterns = [
    ...
    path('cajas/', CajaView.as_view(), name='cajas-abiertas'),

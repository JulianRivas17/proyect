...
SECRET_KEY = 'django-insecure-h&(wk!hi7l-d-kyetzh#kfwe*3!jjbi%17hfl3gu1h65d#8k@*'
...
SIMPLE_JWT = {
  'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),  # Configura el tiempo de expiración del token de acceso a 2 horas
